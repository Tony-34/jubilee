...
<head>
    ...
    <title>Anticipated Endowment Plan</title>
            ...
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 plan-top-left">
                <div class="plan-intro">
                        <div class="plan-intro-in">
                            <h1>Anticipated <br> Endowment Plan</h1>
                            <p>An anticipated endowment is an endowment
policy with guaranteed cash payments payable
to the policy owner at regular intervals
during the term of the policy.</p>                        
                        </div>
                </div>
            ...
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 plan-top-right">
                <img src="images/anticipated-edowment-plan-header.png" alt="" class="plan-banner img-responsive">
            </div>
    </div>
    <!-- career life -->
        <div class="container-fluid finance-philosophy" id="what-we-offer" style="padding-top:0px; margin-top:0px">
           
           <img src="images/pension-plan-inner.png" alt="" class="img-responsive phil-img"> 
            ...
            <div class="phil-right row" style="">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 phil-right-right">
                       <p class="finance-sub-title">Our Product Offering </p>
                       <p class="phil-info">
                       With the anticipated endowment plan, one can
accumulate funds over a period of time through
making periodic, i.e. monthly, quarterly, semi
annual or annual payments, with a goal in mind.
<br>
In addition to this, at certain intervals during the
policy’s term, part of the policy accumulated
benefits are paid out to the policy owner. At the
end of the policy term, the remaining accumulated
benefits are paid to the policy owner as
a lump-sum, together with the accrued bonuses.
<br>
The product further offers life cover which is payable
in the event of death at any time during the term
of the policy and additional benefits such as
accidental death and waiver of premium on death
or disability which can be taken up at the
                    ...
                    <div class="benefits-wrapper row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 benefits-item active">
                            ...
                            <div class="benefit-details">
                                ...
                                <div class="benefit-title-wrapper">
                                    <p class="benefit-title">No <br>set up fee</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 benefits-item">
                            ...
                            <div class="benefit-details">
                                <img src="images/benefitpointer.png" alt="" class="img-responsive benefit-pointer">
                                <div class="benefit-title-wrapper">
                                    <p class="benefit-title">Tax relief <br>benefit</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 benefits-item">
                            ...
                            <div class="benefit-details">
                                <img src="images/benefitpointer.png" alt="" class="img-responsive benefit-pointer">
                                <div class="benefit-title-wrapper">
                                    <p class="benefit-title">Minimum <br> guranteed <br> investment <br>rate of 4%</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 benefits-item">
                            ...
                            <div class="benefit-details">
                                <img src="images/benefitpointer.png" alt="" class="img-responsive benefit-pointer">
                                <div class="benefit-title-wrapper">
                                    <p class="benefit-title">Guaranteed<br>accumulated <br> capital and <br> invetment income </p>
                                </div>
                            </div>
                        </div>
                    </div>
