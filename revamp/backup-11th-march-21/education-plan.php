...
<body>
    ...
    <div class="bg-gray row plan-top" id="top"> 
            <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12 plan-top-left">
                <div class="plan-intro">
                        <div class="plan-intro-in">
                            ...
                            <p>An education policy is a life insurance product
                                specially designed as a savings tool to provide
                                an amount of money for your child’s education.</p>                        
                        </div>
                </div>
                <div class="plan-top-buttons">
                    <button class="get-quote-btn"><a href="">GET QUOTE</a></button>
                    <span class="plan-top-learn-more">  <a href="#career-life-plus">
            ...
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-12 plan-top-right">
                <img src="images/education-plan-banner.png" alt="" class="plan-banner img-responsive">
            </div>
    </div>
    <!-- career life -->
        <div class="container-fluid finance-philosophy" id="career-life-plus" style="padding-top:0px; margin-top:0px">
           
           <img src="images/degreeholder.png" alt="" class="img-responsive phil-img"> 
           
            <div class="phil-right row" style="padding-left:50px;padding-top:50px">
                    ...
                    <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12 phil-right-right">
                       <p class="finance-sub-title">Career Life Plus </p>
                       <p class="phil-info">
                       The smartest way to secure your child’s future
                        begins with investing in the right educational plan.
                        Our Career Life Plus cover is tailored to ensure
                        your child’s dreams are fulfilled through
                        a well-managed fund. Start saving today
                        and we will help your child realise
                        their aspirations.
                ...
                <div class="plan-benefits col-lg-9 col-md-9 col-sm-12 col-xs-12">
                    ...
                    <div class="benefits-wrapper row col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 benefits-item">
                            <img src="images/benefits/financial-security.png" alt="" class="benefit-img img-responsive">
                            <div class="benefit-details">
                                <img src="images/benefitpointer.png" alt="" class="img-responsive benefit-pointer">
                                <div class="benefit-title-wrapper">
                                    <p class="benefit-title">Financial <br>Security</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 benefits-item active">
                            <img src="images/benefits/education.png" alt="" class="benefit-img img-responsive">
                            <div class="benefit-details">
                                <img src="images/benefitpointer.png" alt="" class="img-responsive benefit-pointer">
                                <div class="benefit-title-wrapper">
                                    <p class="benefit-title">Education Savings <br>with life cover</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 benefits-item">
                            ...
                            <div class="benefit-details">
                                <img src="images/benefitpointer.png" alt="" class="img-responsive benefit-pointer">
                                <div class="benefit-title-wrapper">
                                    <p class="benefit-title">Accident &<br>Disability Cover</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-6 benefits-item">
                            ...
                            <div class="benefit-details">
                                <img src="images/benefitpointer.png" alt="" class="img-responsive benefit-pointer">
                                <div class="benefit-title-wrapper">
                                    <p class="benefit-title">Flexible <br>investment options</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="footer-top-wrap row">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 footer-right">
                        ...
                        <p class="footer-contact">
                            ...
                            Tel: +254 20 328 1000 <br>
                            Call Centre: +254 709 949 000 <br>
                            Fax: +254 20 325 1150 <br>
                            Talk2uspension@jubileekenya.com; <br>
                            Talk2uslife@jubileekenya.com
                        </p>
                    </div>                    
                </div>
